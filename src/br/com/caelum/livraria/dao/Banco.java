...
//@Stateless//com stateless criaria uma instancia a cada solicitacao desse EJB,
//como existe um limite de pool de sessionBeans(EJB) em memoria, nao eh uma boa fazer assim
//@Startup//Cria esse sessionBean assim q a aplicacao eh deployada
@Singleton//Cria UM unico sessionBean q sera compartilhado por todos os outros EJB's
public class Banco {
	...
	@PostConstruct
	void aposCriacao(){
		System.out.println("Criou apenas uma vez o Banco");
	}
